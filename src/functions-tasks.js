 ...
 *
 */
function getCurrentFunctionName(func = getCurrentFunctionName) {
  return func.name;
}
...
function logger(func, logFunc) {
  function logAndExecute(args) {
    const message = `${func.name}(${args.map(JSON.stringify).join(',')})`;
  ...
  return (...args) => logAndExecute(args);
}
